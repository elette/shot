...
//             chart.load($xml, "xml");
//             chart.attachEvent("iv", function() {
//                 arrShot[arrShot.length-1][2] = setInterval(reqData, 2000);
//                 return true;
//             });
            chart.attachEvent("iv", setiv());

// alert("_chart count: " + chart.dataCount());
...
// alert($(point).text());
                    if (chart.dataCount() == 10) chart.remove(chart.first());
                });
